...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        <div id="page" class="site">
            ...
            <header id="masthead" class="site-header insider" role="banner" style="background-image: url('<?php echo get_template_directory_uri(); ?>/template_image/header__search.jpg');">
                <div class="container">
