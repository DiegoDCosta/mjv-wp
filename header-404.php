...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        <div id="page" class="site">
            ...
            <header id="masthead" class="site-header insider" role="banner" style="background-image: url('<?php echo get_template_directory_uri(); ?>/template_image/header__404.jpeg');">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 breadcrumbs">
                            <div class="breadcrumbs-itens">                               
                                <h1 class="breadcrumbs-titulo">Error 404: Page not found</h1>
                            </div>                            
                        </div>
                    </div>
                </div>
